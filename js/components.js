            ...
            <div id="newProjectModal" class="hidden fixed inset-0 bg-black/60 backdrop-blur-sm z-[1001] flex items-center justify-center p-4">
                <div class="bg-white rounded-xl shadow-2xl w-full max-w-sm overflow-hidden">
                    ...
                    <form id="newProjectForm" class="p-4 space-y-3">
                        <div><label class="block text-xs font-bold text-gray-700 mb-1">Project Name <span class="text-red-500">*</span></label><input type="text" id="newProjName" class="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg outline-none" required></div>
                        <div id="newProjCustomerContainer">
                            <label class="block text-xs font-bold text-gray-700 mb-1">Link Customer <span class="text-red-500">*</span></label>
                            <select id="newProjCustomer" class="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg outline-none" required>
